...
begin
  ...
  insert into public.products (
    ...
    recommending_mascot, price_pln, price_old_pln,
    ...
    ('pilka-gumowa-piszczek-7cm',
     ...
     null,
     'Piszczy! Każdy jeden raz. Uwielbiam.',
    ...
    ('poslanie-owalne-100x70',
     ...
     null,
     'Tu śpię. Tu marzę. Tu układam plany. Wybieraj rozmiar o jeden większy niż wydaje Ci się potrzebny.',
    ...
    ('smycz-parciana-1-8m-regulowana',
     ...
     null,
     'Krótka w mieście, długa w lesie. Przepinam dwoma palcami w biegu.',
    ...
    ('szczotka-furminator-m',
     ...
     null,
     'Ratunek na sezon linienia. Bez tego nie da się żyć z shibą.',
